...
**NEW!** Work with data that doesn't have latitude/longitude coordinates. geospatialsuite automatically detects and geocodes geographic identifiers:
```r
...
- [**Analyze Crop Vegetation**](https://cran.r-project.org/web/packages/geospatialsuite/vignettes/analyze-crop-vegetation.html) - Using analyze_crop_vegetation() in geospatialsuite ⭐ NEW!
...
See `vignette("performance-benchmark")` for complete benchmarks and reproducible code.
